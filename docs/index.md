...
You can use the [editor on GitHub](https://github.com/haveboard/s9-serato-custom-midi-user-modes-1/edit/master/docs/index.md) to maintain and preview the content for your website in Markdown files.
